...
public class RelatorioController implements Initializable{
	...
	public void CarregarBotoes(){
		...
		cboPeriodoRelatório.getItems().addAll("Mensal", "Anual");
	...
	public void Filtrar(){
		if(cboTipoRelatorio.getSelectionModel().getSelectedItem().equals("Faturamento")){
			if(cboPeriodoRelatório.getSelectionModel().getSelectedItem().equals("Anual")){
			...
			}else if(cboPeriodoRelatório.getSelectionModel().getSelectedItem().equals("Mensal")){
				List<HashMap<Integer,String>> lstHash = Relatorio.ListarFaturamento();
