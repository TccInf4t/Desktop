...
public class GerarLoteController implements Initializable{
	...
	public void PassarTodos(){
		if(tblItensNaoPassados.getItems().isEmpty()){
			Alerta.showError("Erro ao passar todos item", "A tabela Pedidos Sem Lote está vazia");
		}else{
	...
	public void VoltarTodos(){
		if(tblItensPassados.getItems().isEmpty()){
			Alerta.showError("Erro ao passar todos item", "A tabela Pedidos no Lote está vazia");
		}else{
	...
	public void Concluir(){
		if(tblItensPassados.getItems().isEmpty()){
			Alerta.showError("Não foi possivel gerar Lote", "A tabela de Pedidos no Lote está vazia");
		}else{
			Lote lote = new Lote();
