...
public class Pedido {
	...
	public static List<Pedido> Filtrar(boolean temNumPedido, boolean temDataCompra, boolean temEstado, boolean temCidade,
			int numPedido, String dataCompra, Estado estado, Cidade cidade){
